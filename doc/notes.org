...
** TODO Configure Cross-Compiling Toolchain
...
make install
#+END_SRC
** TODO Configure QT for Embedded Linux
*** Steps
...
2. Replace the whole text in mkspecs/qws/linux-arm-g++/qmake.conf by the following:
   #+BEGIN_EXAMPLE
     ...
     load(qt_config)
   #+END_EXAMPLE
3. Turn off compiler optimization by making changes in /mkspecs/common/g++-unix.conf. Change the following line to this :
   #+BEGIN_EXAMPLE
