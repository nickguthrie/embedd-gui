...
This documentation is written under the [[GNU%20Free%20Documentation%20License][GNU Free Documentation License]]. Source code for this documentation can be found [[http://code.google.com/p/embedd-gui/][here]]. The Project page can be found [[http://rcos.rpi.edu/projects/embedd-gui/][here]]. This project would not be possible without funding from the [[http://rcos.rpi.edu/][Rensselaer Center for Open Source]].
